...
out_data_dir="${target_dir}/tag_bio_filt_len_clb_14062023"
...
#	--filter_length
	...
	--in_file "${target_dir}/tag_bio_filt_len_14062023/az_${split}_matches.jsonl" \
        ...
        --check_overlap \
	--labelling_type "match_class"

    python ../../match_idx_to_bio.py \
	--in_file "${target_dir}/tag_bio_filt_len_14062023/az_${split}_matches.jsonl" \
	--out_file "${out_data_dir}_strict/${split}.jsonl" \
	--check_overlap \
	--labelling_type "match_class_strict"
...
python ../../resample_imbalanced.py --in_file "${out_data_dir}_strict/train.jsonl" --out_file "${out_data_dir}_strict/train_seq_resampled.jsonl" --task "sequence_labelling"

         ...
         for pat_head in pat_head_dict:
            ...
            for pattern in patters_list:
                ...
                for pat_idx, pat_tok in enumerate(pattern):
                    ...
                    if all(match):
                        matched_patterns['pattern_indices'].append((sent_offset, sent_offset+pat_len))
...
if __name__ == '__main__':
    ...
    with open("../teufel_patterns/AIM_patterns.json") as f:
    ...
    with open("./s2orc.0.dependency.mcite.txt") as in_f,\
        ...
        parsed_sents_generator = read_sents(in_f) # a generator
        # ref: 
